...
public class ProjectPlanServiceImpl implements ProjectPlanService {
    ...
    public ProjectPlanServiceImpl(OllamaService ollamaService, AiResponseParser aiResponseParser) {
        this.ollamaService = ollamaService;
        this.aiResponseParser = aiResponseParser;
    }

    @Override
    public ProjectPlanResponse generateProjectPlan(String projectName, String cvFilePath, int internshipDays) {
        return generateProjectPlan(projectName, List.of(cvFilePath), internshipDays); // Reuse the multi-CV version
    }

    // ✅ New overloaded method
    public ProjectPlanResponse generateProjectPlan(String projectName, List<String> cvFilePaths, int internshipDays) {
        ...
        String prompt = String.format("""
            ...
            """, combinedCvText.toString(), internshipDays, projectName, internshipDays, projectName, internshipDays);
